...
export const Bio = () => {
    const [displayedText, setDisplayedText] = useState("");
    const bioText = [
        "Hi, I'm Fourat Anderi, a dedicated Full-Stack JavaScript Developer with a strong background in telecommunications and networks. My journey from embedded systems to solving technical challenges as a developer has been driven by my passion for problem-solving, innovation, and continuous learning.",
        "With a solid command of technologies like React, Node.js, and JavaScript, I thrive on creating solutions that merge efficiency with user-friendly designs. I enjoy collaborating within dynamic teams and always aim to contribute to high-quality, impactful projects.",
        "I'm constantly refining my skills and currently exploring the exciting world of TypeScript. Whether it's building efficient web apps or working on complex systems, I believe in the power of technology to transform ideas into reality.",
        "When I'm not coding, you'll probably find me exploring music or brainstorming new project ideas. My values of integrity, innovation, and a dedication to lifelong learning keep me motivated as I work toward mastering full-stack development and leading in dynamic environments.",
        "Key Highlights:",
        "Technical Skills: JavaScript, React.js, Node.js, MySQL, MongoDB, HTML, CSS",
        "Experience: Transitioned from telecommunications to full-stack development, with expertise in building both frontend and backend solutions",
        "Education: Master's degree in Telecommunications and Networks, Bachelor's degree in Embedded Systems"
    ];
    ...
    return (
        <div style={{ marginTop:'100px',padding: '20px', maxWidth: '600px', margin: 'auto', whiteSpace: 'pre-wrap', opacity: 1, transition: 'opacity 2s', color:'white',fontFamily: 'Noto Sans JP', lineHeight: '1.6', wordSpacing: '0.1em' }}>
            {displayedText}
        </div>
    );
};
